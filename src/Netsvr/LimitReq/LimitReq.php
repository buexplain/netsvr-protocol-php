...
class LimitReq extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $ctxData
     *          worker会原样回传给business
     *     @type array<\Netsvr\LimitReq\LimitUpdateItem>|\Google\Protobuf\Internal\RepeatedField $items
     *          要更新的限流配置，如果只想获取网关中的限流配置的真实情况，可以不传递
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\LimitReq::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .netsvr.limitReq.LimitUpdateItem items = 3;</code>
     * @param array<\Netsvr\LimitReq\LimitUpdateItem>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Netsvr\LimitReq\LimitUpdateItem::class);
        $this->items = $arr;
