...
namespace Netsvr\TopicCountReq;
 ...
 *
 * Generated from protobuf message <code>netsvr.topicCountReq.TopicCountReq</code>
 */
class TopicCountReq extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\TopicCountReq::initOnce();
