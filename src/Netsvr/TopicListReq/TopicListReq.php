 ...
 *
 * Generated from protobuf message <code>netsvr.topicListReq.TopicListReq</code>
 */
class TopicListReq extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\TopicListReq::initOnce();
