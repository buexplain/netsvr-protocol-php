...
# source: uniqIdCountReq.proto

namespace Netsvr\UniqIdCountReq;
...
/**
 *business向worker请求，获取网关中uniqId的数量
 *
 * Generated from protobuf message <code>netsvr.uniqIdCountReq.UniqIdCountReq</code>
 */
class UniqIdCountReq extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\UniqIdCountReq::initOnce();
